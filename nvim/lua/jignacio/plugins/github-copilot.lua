local prompts = {
	...
	Review = "Please review the following code and provide suggestions for improvement. If you need more context about the code, please ask for it.",
	Tests = "Generate unit tests for it. If you need more context about the code, please ask for it.",
